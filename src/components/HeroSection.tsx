...
const secondaryArticles: SecondaryArticle[] = [
  {
    id: 1,
    category: "Politics",
            ...
            <div className="relative overflow-hidden rounded-lg">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                ...
                <h1 className="font-headline text-2xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-3">
                  Global Leaders Convene for Historic Climate Summit as Temperatures Reach Record Highs
                </h1>
                <p className="font-body text-gray-200 text-base md:text-lg mb-4 line-clamp-2 max-w-3xl">
                  World leaders gather in Geneva to address the escalating climate crisis, with new commitments expected to reshape global environmental policy for the next decade.
                </p>
